...
/* NOTE: Changed from Japanese to U.S. */
...
/* NOTE: Might want to enable LFN? On the BSS in single-thread env.
    also include ffunicode.c.
*/
#define FF_USE_LFN		1
...
/* NOTE: I think 0 or 2 would be fine? As an SFN is generated. */
...
/* NOTE: made file creation time info visible */
...
/* NOTE: free cluster count on FSINFO is fine. */
...
/* NOTE: probably don't need to lock, if we're good about our files. */
#define FF_FS_LOCK		0
