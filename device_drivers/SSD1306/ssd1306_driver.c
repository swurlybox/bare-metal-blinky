...
void display_update() {
    ...
    /* TODO: Refactor this to make use of DMA */
    i2c_transmit(I2C1, DISPLAY_I2C_ADDR, display_buf, DISPLAY_BYTE_SIZE);
}
...
void display_init() {
    ...
    data[2] = 0x80;
    data[3] = 0x3F;
    i2c_transmit(I2C1, DISPLAY_I2C_ADDR, data, 4);
    ...
    data[1] = 0x40;
    i2c_transmit(I2C1, DISPLAY_I2C_ADDR, data, 2);
    ...
    data[1] = 0xD5;
    data[3] = 0x80;
    i2c_transmit(I2C1, DISPLAY_I2C_ADDR, data, 4); /* around 117 fps */
